...
// of cmd_local/compile by almost 10%, and slows it down.
//go:noinline
...
// Reg returns the register assigned to v, in cmd_local/internal/obj/$ARCH numbering.
...
// Reg0 returns the register assigned to the first output of v, in cmd_local/internal/obj/$ARCH numbering.
...
// Reg1 returns the register assigned to the second output of v, in cmd_local/internal/obj/$ARCH numbering.
