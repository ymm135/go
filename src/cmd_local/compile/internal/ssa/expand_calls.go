...
func expandCalls(f *Func) {
	...
	rewriteSelect = func(leaf *Value, selector *Value, offset int64) []LocalSlot {
		...
		case OpLoad: // We end up here because of IData of immediate structures.
			...
			//
			// GOSSAFUNC='(*dumper).dump' go build -gcflags=-l -tags=math_big_pure_go cmd_local/compile/internal/gc
			// cmd_local/compile/internal/gc/dump.go:136:14: internal compiler error: '(*dumper).dump': not lowered: v827, StructSelect PTR PTR
			// b2: ← b1
