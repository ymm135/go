...
func bmap(t *types.Type) *types.Type {
	fmt.Println("xiaoming bmap type:", t)
...
func deferstruct(stksize int64) *types.Type {
	...
	// cmd_local/compile/internal/gc/ssa.go:(*state).call.
	fields := []*types.Field{
...
//	cmd_local/compile/internal/gc/reflect.go
//	cmd_local/link/internal/ld/decodesym.go
//	reflect/type.go
//	runtime/type.go
const (
	tflagUncommon      = 1 << 0
