...
/*
 * These data structures are known to the compiler (../../cmd/internal_local/gc/reflect.go).
...
//	cmd/compile/internal_local/gc/reflect.go
//	cmd/link/internal_local/ld/decodesym.go
//	runtime/type.go
type tflag uint8
