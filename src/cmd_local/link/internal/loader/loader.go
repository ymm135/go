...
func (l *Loader) checkdup(name string, r *oReader, li uint32, dup Sym) {
	...
	fmt.Fprintf(os.Stderr, "cmd_local/link: while reading object for '%v': duplicate symbol '%s', previous def at '%v', with mismatched payload: %s\n", r.unit.Lib, name, rdup.unit.Lib, reason)
...
func (l *Loader) LoadSyms(arch *sys.Arch) {
	...
	// This function was determined empirically by looking at the cmd_local/compile on
...
//
// Logging an error means that on exit cmd_local/link will delete any
