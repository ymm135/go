...
import (
	intdwarf "cmd_local/internal/dwarf"
	objfilepkg "cmd_local/internal/objfile" // renamed to avoid conflict with objfile function
	"debug/dwarf"
	"debug/pe"
	"errors"
	"fmt"
...
// External linking requires a host linker (https://golang.org/src/cmd_local/cgo/doc.go l.732)
