...
func TestPkgDefaultExecName(t *testing.T) {
	...
	for _, tt := range []struct {
		...
		{"example.com/mycmd_local/v0", []string{}, "v0", "v0"},
		{"example.com/mycmd_local/v1", []string{}, "v1", "v1"},
		{"example.com/mycmd_local/v2", []string{}, "mycmd", "v2"}, // Semantic import versioning, use second last element in module mode.
		{"example.com/mycmd_local/v3", []string{}, "mycmd", "v3"}, // Semantic import versioning, use second last element in module mode.
		{"mycmd", []string{}, "mycmd", "mycmd"},
		{"mycmd_local/v0", []string{}, "v0", "v0"},
		{"mycmd_local/v1", []string{}, "v1", "v1"},
		{"mycmd_local/v2", []string{}, "mycmd", "v2"}, // Semantic import versioning, use second last element in module mode.
		{"v0", []string{}, "v0", "v0"},
		{"v1", []string{}, "v1", "v1"},
		{"v2", []string{}, "v2", "v2"},
