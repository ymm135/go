...
the documentation for these and other vet tests via "go doc cmd_local/vet".
...
func declareCoverVars(p *load.Package, files ...string) map[string]*load.CoverVar {
	...
	for _, file := range files {
		...
		// These names appear in the cmd_local/cover HTML interface.
		var longFile string
		if p.Internal.Local {
