...
import "cmd_local/go/internal/base"
...
information on how to use it see the cgo documentation (go doc cmd_local/cgo).
...
Import paths beginning with "cmd_local/" only match source code in
the Go repository.
...
is not a vendored package: cmd_local/vendor would be a command named vendor,
and the pattern cmd_local/... matches it.
