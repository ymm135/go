...
// (for example, buildV) are in cmd_local/go/internal/cfg.

var (
	forcedAsmflags   []string // internally-forced flags for cmd_local/asm
	forcedGcflags    []string // internally-forced flags for cmd_local/compile
	forcedLdflags    []string // internally-forced flags for cmd_local/link
...
func runInstall(ctx context.Context, cmd *base.Command, args []string) {
	...
	// if all named packages are in GOROOT. cmd_local/dist (run by make.bash) uses
