...
// x/tools/cmd_local/godoc/goroot.go.
...
//
// There is a copy of this code in x/tools/cmd_local/godoc/goroot.go.
...
// which is necessary for useful operation of the cmd_local/go tool,
