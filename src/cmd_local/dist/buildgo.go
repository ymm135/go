...
/*
 * Helpers for building cmd_local/go and cmd_local/cgo.
 */
...
//
// It is invoked to write cmd_local/go/internal/cfg/zdefaultcc.go
// but we also write cmd_local/cgo/zdefaultcc.go
...
// mkzcgo writes zosarch.go for cmd_local/go.
