...
func TestMain(m *testing.M) {
	...
	buildCtx.GOPATH = ""
	testGOPATH = true // force GOPATH mode; module test is in cmd_local/go/testdata/script/mod_doc.txt

	// Add $GOROOT/src/cmd_local/doc/testdata explicitly so we can access its contents in the test.
...
const p = "cmd_local/doc/testdata"
...
var tests = []test{
	...
	// Package dump includes import, package statement.
	{
		"package clause",
		[]string{p},
		[]string{`package pkg.*cmd_local/doc/testdata`},
		nil,
	},
