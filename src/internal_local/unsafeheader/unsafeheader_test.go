...
func TestTypeMatchesReflectType(t *testing.T) {
	t.Run("Slice", func(t *testing.T) {
		testHeaderMatchesReflect(t, Slice{}, reflect.SliceHeader{})
	})

	t.Run("String", func(t *testing.T) {
		testHeaderMatchesReflect(t, String{}, reflect.StringHeader{})
	})
}
...
func TestWriteThroughHeader(t *testing.T) {
	t.Run("Slice", func(t *testing.T) {
		...
		var alias []byte
		hdr := (*Slice)(unsafe.Pointer(&alias))
	...
	t.Run("String", func(t *testing.T) {
		...
		var alias string
		hdr := (*String)(unsafe.Pointer(&alias))
